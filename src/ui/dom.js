...
export const UI_ELEMENT_IDS = [
  ...
  "ditherSourceGuardAmountValue",
  "ditherSourceGuardMinGain",
  "ditherSourceGuardMinGainValue",
  "ditherSourceGuardFlatThreshold",
  "ditherSourceGuardFlatThresholdValue",
  "edgeTightenEnabled",
  "edgeTightenStrength",
  "edgeTightenStrengthValue",
  "cyclePreviewToggle",
  "cyclePreviewSpeed",
  ...
  "diagnosticsHistogramBinCount",
  "diagnosticsHistogramBinCountValue",
  "diagnosticsHistogramHint",
