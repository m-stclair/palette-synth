  ...
  if (trace) {
    ...
    trace.push({
      ...
      constants: {
        ...
        hueSpreadBonus,
        hueReliabilityMidNeutral: NEUTRAL_CHROMA_EPSILON,
        hueReliabilityMidClear: CLEAR_HUE_CHROMA,
        hueReliabilityEndpointNeutral: ENDPOINT_NEUTRAL_CHROMA_EPSILON,
        hueReliabilityEndpointClear: ENDPOINT_CLEAR_HUE_CHROMA,
  ...
  for (let slot = selected.length; slot < N; slot++) {
    ...
    for (const entry of poolBase) {
      ...
      const parts = {
        ...
        hueCandidateLightness: hueNearest.candidateLightness,
        hueCandidateChroma: hueNearest.candidateChroma,
        hueCandidateNeutralChroma: hueNearest.candidateNeutralChroma,
        hueCandidateClearChroma: hueNearest.candidateClearHueChroma,
