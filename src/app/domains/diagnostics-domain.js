...
export function createDiagnosticsDomain({
  ...
  const panel = createDiagnosticsPanel({
    ...
    onGraphMatchAnchorReposition: repositionManualGraphMatchAnchor,
  ...
  controller = createDiagnosticsController({
    ...
    sourceCloudSignature: metrics.sourceCloudSignature,
    computeSourcePixelCloudDiagnostics: metrics.computeSourcePixelCloudDiagnostics,
    diagnosticsActiveTab: panel.activeHistogramTab,
    diagnosticsActiveXrayMode: panel.activeXrayMode,
