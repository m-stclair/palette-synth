...
export const ENDPOINT_NEUTRAL_CHROMA_EPSILON = 8.0;
export const ENDPOINT_CLEAR_HUE_CHROMA = 14.0;
export const HUE_LIGHTNESS_HEADROOM_LOW = 8.0;
export const HUE_LIGHTNESS_HEADROOM_HIGH = 24.0;
