...
export const NEUTRAL_CHROMA_EPSILON = 1.2;
export const CLEAR_HUE_CHROMA = 6.0;
export const ENDPOINT_NEUTRAL_CHROMA_EPSILON = 5.0;
export const ENDPOINT_CLEAR_HUE_CHROMA = 11.0;
export const HUE_LIGHTNESS_HEADROOM_LOW = 7.0;
export const HUE_LIGHTNESS_HEADROOM_HIGH = 23.0;
export const HUE_DISTANCE_SCALE = 10.0;
